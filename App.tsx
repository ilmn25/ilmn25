...
const App: React.FC = () => {
    ...
    const getCleanPath = useCallback(() => {
        const hash = window.location.hash; // e.g., "#/illustrations/sketches"
    ...
    const handleRouting = useCallback(() => {
        ...
        if (projectPages[mainRoute]) {
            ...
            // Handle subrouting for illustrations
    ...
    const handleProjectClick = (projectId: string) => {
        ...
        // When clicking illustrations from outside, default to colored subroute
