...
const Navbar: React.FC<NavbarProps> = ({ scrollToSection, onProjectClick, basePath }) => {
  ...
  return (
    <>
      {/* Desktop Navbar - Absolute position to scroll away */}
      ...
      {/* Mobile Navbar Logo Header - Absolute position to scroll away */}
      ...
      {/* Mobile Menu Button - Fixed so it doesn't scroll away */}
