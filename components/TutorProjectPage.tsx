                    ...
                    <section className="mb-16 pb-10">
                        ...
                        <div className="space-y-12">
                            {Object.entries(TUTOR_GALLERY_GROUPS).map(([sectionName, imageIndices]) => {
                                const isPortrait = sectionName === "Screen Size Responsive UI";
                                ...
                                return (
                                    <div key={sectionName} className="space-y-4">
                                        ...
                                        <div className={`grid ${isPortrait ? 'grid-cols-2 md:grid-cols-4 lg:grid-cols-5' : 'grid-cols-2 md:grid-cols-3 lg:grid-cols-3'} gap-3 md:gap-4`}>
                                            {imageIndices.map((idx, groupIdx) => {
                                                const img = TUTOR_GALLERY[idx - 1];
                                                if (!img) return null;
                                                return (
                                                    <RevealOnScroll key={idx} direction="up" delay={groupIdx * 50}>
                                                        <div
