...
const PRESET_ORDERS: Record<Category, number[] | null> = {
    ...
    sketches: [30, 21, 33, 9, 22, 32, 13, 56, 54, 43, 24, 45, 35, 37, 16, 4, 25, 42, 51, 50, 10, 36, 7, 38, 5, 1, 52, 8, 46, 26, 18, 14, 11, 39, 53, 29, 15, 19, 12, 31, 47, 17, 2, 6, 34, 55, 44, 49, 41, 3, 48, 40, 20, 28]
};
      ...
      `}} />
            ...
            <div className="min-h-screen bg-white pt-24 pb-20 px-8 md:px-12 lg:px-16 overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div key={`${activeCategory}-${shuffleKey}`} className="flex flex-row gap-6 md:gap-8 justify-center">
